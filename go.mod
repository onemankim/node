...
require (
	...
	github.com/projectcalico/felix v0.0.0-20200903155432-90fa8f415504
...
replace (
	github.com/kelseyhightower/confd => github.com/onemankim/confd v1.0.1-0.20210115082641-22d80d085b66
